...
INSERT INTO technician_categories (technician_id, category_id) VALUES (1,2),(2,2),(3,2),(4,2);
...
(1010, 1, 1, 2, 1, 'المشكلة في الإضاءة لا تعمل. يحتاج فحص وإصلاح مع استبدال القاطع إن لزم الأمر.', 'in_progress', '2024-05-12', 'أقرب موعد', 200.00, 'unpaid');
