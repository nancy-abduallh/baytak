...
import { Check, X, Pencil, Trash2, Plus, Search, Ban, PlayCircle } from "lucide-react";
            ...
            render: (t) => (
                <div className="flex flex-wrap items-center gap-1.5">
                    <button
                        ...
                        className={`grid h-8 w-8 place-items-center rounded-full disabled:opacity-50 ${t.isVerified ? "bg-danger/10 text-danger" : "bg-teal-700 text-white"}`}
                    >
                    ...
                    <button
                        ...
                        className={`grid h-8 w-8 place-items-center rounded-full disabled:opacity-50 ${t.isActive ? "bg-gold-100 text-[#8A6417]" : "bg-green-100 text-green-500"}`}
                    >
    ...
    return (
        <div>
            ...
            <div className="mb-5 flex items-center justify-between gap-3">
                <div className="flex items-center gap-2 rounded-full border border-line bg-white px-4 py-2.5 w-[300px]">
