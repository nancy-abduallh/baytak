export declare const ADMIN_PERMISSIONS: readonly ["dashboard.view", "orders.view", "orders.update_status", "orders.delete", "technicians.manage", "users.manage", "categories.manage", "admins.manage"];
