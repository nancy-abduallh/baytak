...
export function StepsSection() {
    return (
        <div id="how-it-works" className="mx-auto max-w-[1360px] px-10">
            <div className="relative overflow-hidden rounded-[32px] bg-teal-900 px-14 py-16">
                <div className="mb-11">
                    <div className="text-[13.5px] font-bold text-green-500">آلية العمل</div>
                    <h2 className="mt-2.5 font-heading text-[32px] font-extrabold text-white">من الطلب إلى الإنجاز في ٤ خطوات</h2>
                    <p className="mt-2 max-w-[440px] text-[15px] text-[#AFC9C0]">تسلسل واضح يمنحك رؤية كاملة لحالة طلبك من اللحظة الأولى.</p>
                </div>

                <div className="relative grid grid-cols-4">
                    <div className="absolute end-[12%] start-[12%] top-[27px] h-px bg-[repeating-linear-gradient(90deg,rgba(255,255,255,.3)_0_8px,transparent_8px_16px)]" />
                    {STEPS.map((step) => (
