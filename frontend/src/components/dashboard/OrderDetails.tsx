...
export function OrderDetails({ order }: { order: Order }) {
    return (
        <div className="mt-6 rounded-md border border-line bg-white p-4 sm:p-6">
            <h4 className="mb-4 text-[15px] font-bold">تفاصيل الطلب {order.orderNumber}</h4>
            <div className="mb-4 grid grid-cols-2 gap-4 border-b border-dashed border-line pb-5 text-[13.5px] text-[#57655F] sm:grid-cols-4 sm:gap-5">
